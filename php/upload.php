<?php
    ...
    $sql = "INSERT INTO movietbl (name, year, genre, description, cover, magnet, poster) 
            VALUES ('$movieName', '$movieYear', '$movieGenre', '$movieAbout','$movieCover', '$movieLink', '$moviePoster')";
